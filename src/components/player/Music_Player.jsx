    ...
    return(
        <>
        {
                ...
                <div className="bg-[#4d5156] border-slate-100 transition-all duration-500 dark:bg-slate-800  dark:border-slate-500 border-b rounded-t-xl px-4  pt-[5px] pb-6   ">
                    ...
                    <div className="space-y-2">
                        <div className="relative">
                            ...
                            <div
                                className="ring-cyan-500 transition-all duration-500 dark:ring-cyan-400 ring-2 absolute left-0 top-1/2 w-4 h-4 -mt-2 -ml-2 flex items-center justify-center bg-[#4d5156] rounded-full shadow">
                                <div
                                    className="w-1.5 h-1.5 bg-cyan-500 transition-all duration-500 dark:bg-cyan-400 rounded-full ring-1 ring-inset ring-slate-900/5">
                                </div>
                            </div>
            ...
            :
                    ...
                    <div className="bg-white border-slate-100 transition-all duration-500 dark:bg-slate-800  dark:border-slate-500 border-b rounded-t-xl px-4 pt-[5px] pb-6  ">
                        <button onClick={(e)=>{setIsClose(true)}}className="absolute top-[20px] right-[20px] sm:hidden">
                            <img className="w-[25px] h-[25px]" src={close}></img>
                        </button>
